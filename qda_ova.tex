...
\hypersetup{
  pdftitle={Analyse Discriminante Quadratique (QDA) - One-Versus-All (OVA)},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\pandocbounded{\includegraphics[keepaspectratio]{qda_ova_files/figure-pdf/cell-2-output-2.pdf}}
