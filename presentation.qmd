...
- **K-Nearest Neighbors (KNN - Multiclasse, OVA et OVO)**
...
- **Forêt Aléatoire (Random Forest)**
- **Réseau de Neurones (MLP avec sortie Softmax)**
- **K-Nearest Neighbors (KNN Multiclasse)**
...
- **K-Nearest Neighbors (KNN - OVA et OVO)**
